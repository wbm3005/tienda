...
//        registry.addViewController("/info").setViewName("contacto");
//        registry.addViewController("/aboutUs").setViewName("contacto");
//        registry.addRedirectViewController("/producto/list", "/producto/listado");
    }
